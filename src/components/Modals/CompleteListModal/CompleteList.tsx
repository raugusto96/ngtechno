...
import { ButtonContainer, Container, Paragraph, SvgContainer } from "./styles";
...
const CompleteListModal: React.FC = () => {
  ...
  return (
    <Container>
      ...
      <SvgContainer>
        <img src={assets.svgs.list.icon.src} alt={assets.svgs.list.icon.alt} />
      </SvgContainer>
      <ButtonContainer>
        <Button text='Feminino' icon={<MdFemale size='20px' opacity='0.5' />} />
        <Button text='Masculino' icon={<MdMale size='20px' opacity='0.5' />} />
      </ButtonContainer>
      <Button
        text='Voltar'
